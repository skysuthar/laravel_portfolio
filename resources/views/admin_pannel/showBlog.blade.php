                ...
                <tbody>
                 ...
                 @foreach($blog as $blog)
                  <tr>
                    ...
                    <td><img src='{{asset("root/blogImages/$blog->blog_image")}}' height="60px" width="60px"></td>
                    <td>{{$blog->blog_about}}</td>
                    <td>@php 
                            echo strlen($blog->blog_description) >= 170 ? substr($blog->blog_description, 0,170):$blog->blog_description;
                        @endphp
                    </td>
                    <td>{{$blog->blog_status}}</td>
                    <td>
                        <div class="leave-action text-start d-flex">
                            <a href="{{ route('editBlog',$blog->id) }}" class="eye">
                            ...
                            <a href="javascript:void(0);" data-target="#accept" data-toggle="modal" class="approve ml-1 delete" data-id="{{$blog->id}}">
